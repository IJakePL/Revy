...
module.exports = class TwoZeroFourEight {
    ...
    async startGame() {
        ...
        const row = new MessageActionRow().addComponents(dis1, up, dis2)
        const row1 = new MessageActionRow().addComponents(left, down, right)

        const msg = await this.sendMessage({ embeds: [embed], components: [row, row1], files: [this.getImage()] })
